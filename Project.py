# Игра в стиле файтинг
# Помимо стандартных используется библиотека pygame и random
# Есть режим одиночной игры и мультиплеер
# В игре присутствует возможность взаимодействия с плаформой и вылетающими атомами
# При столкновении атомы менят траекторию рандомным образом, ускоряются и преобретают дополнительный урон
# В окне настроек можно изенить время раунда
# Управление:
#   для первого игрока
#       WASD - движение
#       G - удар рукой
